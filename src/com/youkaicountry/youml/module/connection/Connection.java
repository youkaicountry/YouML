...
public abstract class Connection extends Module
{
    ...
    {
        super(name);
        this.moduleInit(module_a.output_dim, module_a.output_buffer, a_offset, module_a.output_error_buffer, b_erroffset, module_b.input_dim, module_b.input_buffer, b_offset, module_b.input_error_buffer, b_erroffset, new SingleVector(parameters, this));
